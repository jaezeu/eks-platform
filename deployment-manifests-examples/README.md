...
| [ingress-coaching](ingress-coaching/) | Exposing an app through an Ingress, plus a [netshoot](https://github.com/nicolaka/netshoot) pod for in-cluster network debugging. |
